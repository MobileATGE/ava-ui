class AvaUI {
  ...
  includeAva(user) {
    ...
    iconDiv.innerHTML = '<img style="border-radius: 50%;" src="https://ava-ui-dev.herokuapp.com/ava-icon.png" class="sc-open-icon" width="30" height="30"/>';
  ...
  includeFlyoutPanelAva(user) {
    ...
    targetParent.firstChild.innerHTML = '<img style="border-radius: 50%;" src="https://ava-ui-dev.herokuapp.com/ava-icon.png" class="sc-open-icon" width="30" height="30"/>';
